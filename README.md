...
The goal is to make development environments reproducible, portable, and teachable.

A developer should be able to move to a new machine, clone this repository, run a bootstrap script, and rebuild the core AI engineering workstation.
